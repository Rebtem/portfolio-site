        ...
        <div className="grid grid-cols-2 gap-6 mt-6">
          <div>
            ...
            <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">✔️ Supabase (Authentication, Database, Storage </p>
              <p className="text-sm text-gray-500 dark:text-gray-400">✔️ PostgreSQL (via Supabase)</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">✔️ Firebase (basic familiarity)</p>
              <p className="text-sm">Tools & Workflow</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">✔️ Git & GitHub</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">✔️ Vercel, Netlify</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">✔️ Figma (for UI design interpretation)</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">✔️  Agile & Scrum</p>
