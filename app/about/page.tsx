      ...
      <div className="w-full max-w-3xl px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
          ...
          <div className="text-left space-y-2">
            ...
            <p>Calendar & schedule management</p>
            <p>Email management & inbox organization</p>
            <p>Data entry & document handling</p>
            <p>Customer service & live chat support</p>
            <p>Social media management (Hootsuite)</p>
            <p>Task management tools (Trello)</p>
            <p>Microsoft Office.( Powerpoint, word, excel)</p>
          </div>
          ...
          <div className="text-left space-y-4">
            ...
            <p>Next.js, React.js, TypeScript</p>
            <p>Tailwind CSS, CSS3, SCSS</p>
            <p>JavaScript (ES6+), HTML5</p>
        ...
        <p className="text-center text-gray-600 dark:text-gray-300 mt-6">
          I thrive on solving complex problems and continually learning new
          technologies. My goal is to contribute to innovative projects that
          make a positive impact. Lets work together to bring your ideas to
          life!
        </p>
      </div>
    </section>
